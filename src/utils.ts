            ...
            if (y <= endYear) {
                ...
                if ((useAdjustment || useUnify) && y >= 2026) {
                    ...
                    if (useAdjustment) {
                        ...
                        const nextTheoryRankNewManual = calculatePts(calculatePeriodYears(pointCalcBaseDate, rankCalcEndDate, getMode('rank')), rankKeyNew, false, getMode('rank'), unifyTargetMaster);
