            ...
            <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                    {['type1','type2','type3'].map((t, i) => (
                        <div key={t}>
                            <span className="block text-[11px] text-slate-400 text-center mb-0.5">{['旧①','旧②','旧③'][i]}</span>
                            <input 
            ...
            {config.transitionConfig.enabled && (
                <div className="p-3 bg-indigo-50/50 rounded-lg border border-indigo-100 animate-in fade-in slide-in-from-top-1">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {['type1','type2','type3'].map((t, i) => (
                            <div key={t}>
                                <span className="block text-[11px] text-indigo-400 text-center mb-0.5">{['旧①','旧②','旧③'][i]}</span>
                                <input 
                                    type="number" min={30} max={47}
